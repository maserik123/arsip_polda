                    ...
                    <form method="post" action="arsip_update.php" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="kode" required="required"
                                value="<?php echo $d['arsip_kode']; ?>" readonly>
                        </div>
                        ...
                        <div class="form-group">
                            <label>Aktif Tahun RC</label>
                            <input type="number" class="form-control" name="aktif_tahun_rc" required="required"
                                value="<?php echo $d['aktif_tahun_rc']; ?>">
                        </div>
