...
<head>
    ...
    <title>RC - Sistem Informasi Arsip Digital</title>
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a href="arsip.php" aria-expanded="false"><span
                                    class="fas fa-thin fa-folder icon-wrap sub-icon-mg" aria-hidden="true"></span> <span
                                    class="mini-click-non">Data Arsip</span></a>
                        </li>

                        <li>
                            <a href="gantipassword.php" aria-expanded="false"><span
                                    class="fa fa-solid fa-key icon-wrap sub-icon-mg" aria-hidden="true"></span>
                                <span class="mini-click-non">Ganti Password</span></a>
                        </li>

                        <li>
                            <a href="logout.php" aria-expanded="false"><span
                                    class="fa fa-solid fa-right-from-bracket icon-wrap sub-icon-mg"
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav">
                                                ...
                                                <!-- <li class="nav-item dropdown res-dis-nn">
                                                    <a href="#" data-toggle="dropdown" role="button"
                                                        aria-expanded="false" class="nav-link dropdown-toggle">Kategori
                                                    ...
                                                    <div role="menu" class="dropdown-menu animated zoomIn">
                                                        ...
                                                        ?>
                                                        <a href="arsip.php?kategori=<?php echo $p['kategori_id'] ?>"
                                                            class="dropdown-item"><?php echo $p['kategori_nama'] ?></a>
                                                        <?php
                                                        }
                                                        ?>
                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul class="mobile-menu-nav">
                                        ...
                                        <li>
                                            <a href="arsip.php" aria-expanded="false"><span
                                                    class="fas fa-thin fa-folder icon-wrap sub-icon-mg"
                                        ...
                                        <li>
                                            <a href="gantipassword.php" aria-expanded="false"><span
                                                    class="fa fa-solid fa-key icon-wrap sub-icon-mg"
