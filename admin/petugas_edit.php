                ...
                <div class="panel-body">
                    ...
                    ?>
                        ...
                        <form method="post" action="petugas_update.php" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>Email</label>
                                <input type="email" value="<?php echo $d['email'] ?>" class="form-control" id="email" name="email" required="required">
                            </div>
                            <div class="form-group">
                                <label>Jabatan</label>
                                <select name="jabatan" id="jabatan" class="form-control">
                                    <option value="">Pilih Jabatan</option>
                                    <?php if ($d['jabatan'] == 'pimpinan') { ?>
                                        <option value="pimpinan" selected>Pimpinan</option>
                                        <option value="petugas">Petugas</option>

                                    <?php } else if ($d['jabatan'] == 'petugas') { ?>
