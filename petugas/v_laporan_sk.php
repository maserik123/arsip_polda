                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="breadcome-heading">
                                <form action="v_laporan_sk.php" method="get">
                                    <div class="row">
                                    ...
                                    if (isset($_GET['filter'])) // Jika user mengisi filter tanggal, maka munculkan tombol untuk reset filter
                                        echo '<a href="v_laporan_sk.php" class="btn btn-default">RESET</a>';
                                    ?>
...
<div class="container-fluid">
    <div class="panel panel">
        ...
        <!-- <div class="panel-heading">
            <h3 class="panel-title">Laporan dari <?php echo $_GET['tgl_akhir'] . " Sampai " . $_GET['tgl_akhir'] ?></h3>
        </div> -->
            ...
            <table id="table" class="table table-bordered  table-datatable">
                ...
                <tbody>
                    ...
                    if (isset($_GET['tgl_awal'])) {
                        ...
                        $arsip = mysqli_query($koneksi, "SELECT * FROM arsip,kategori,petugas WHERE arsip_petugas=petugas_id and arsip_petugas='$saya' and jenis_surat='$jenis'  and tanggal_surat BETWEEN '" . $tgl_awal . "' AND '" . $tgl_akhir . "' ORDER BY arsip_id DESC");
                    } else {
                        $arsip = mysqli_query($koneksi, "SELECT * FROM arsip,kategori,petugas WHERE arsip_petugas=petugas_id and arsip_petugas='$saya' and jenis_surat='$jenis'  ORDER BY arsip_id DESC");
                    }
    ...
    <div class="row">
        <div class="col-lg-3">
            <a href="cetak_sk.php?awal=<?= $tgl_awal; ?>&&akhir=<?= $tgl_akhir; ?>" target="_blank"
                class="btn btn-primary" rel="noopener noreferrer">Cetak Laporan</a>
        </div>
    </div>
</div>
