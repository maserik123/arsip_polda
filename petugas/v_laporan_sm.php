                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="breadcome-heading">
                                <form action="v_laporan_sm.php" method="get">
                                    <div class="row">
                                    ...
                                    if (isset($_GET['filter'])) // Jika user mengisi filter tanggal, maka munculkan tombol untuk reset filter
                                        echo '<a href="v_laporan_sm.php" class="btn btn-default">RESET</a>';
                                    ?>
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-3">
            <a href="cetak_sm.php?awal=<?= $tgl_awal; ?>&&akhir=<?= $tgl_akhir; ?>" target="_blank"
